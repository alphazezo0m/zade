...
print('''\033[91m
__________       __                                 
\____    /____  |  | _______ _______ ___.__._____   
  /     /\__  \ |  |/ /\__  \\_  __ <   |  |\__  \  
 /     /_ / __ \|    <  / __ \|  | \/\___  | / __ \_
/_______ (____  /__|_ \(____  /__|   / ____|(____  /
        \/    \/     \/     \/       \/          \/ 
       CREATED BY HACKER Zakarya S Aziz 
''')
def slowprint(s):
    for c in s + '\n' :
        sys.stdout.write(c)
...
+--------------------------------------+
| Coded By  @Zakarya S aziz |version : 3.0|
+--------------------------------------+''')
...
os.system ("am start -a android.intent.action.VIEW -d https://www.facebook.com")
